...
dfig1 = np.fromfile('validation_pml0/snapz00801', dtype=np.float32)
dfig1 = dfig1.reshape(481, 481).swapaxes(1,0)

dfig2 = np.fromfile('validation_pml1/snapz00801', dtype=np.float32)
dfig2 = dfig2.reshape(481, 481).swapaxes(1,0)

dfig3 = np.fromfile('validation_pml0/snapz01201', dtype=np.float32)
dfig3 = dfig3.reshape(481, 481).swapaxes(1,0)

dfig4 = np.fromfile('validation_pml1/snapz01201', dtype=np.float32)
dfig4 = dfig4.reshape(481, 481).swapaxes(1,0)

dfig5 = np.fromfile('validation_pml0/snapz01601', dtype=np.float32)
dfig5 = dfig5.reshape(481, 481).swapaxes(1,0)

dfig6 = np.fromfile('validation_pml1/snapz01601', dtype=np.float32)
