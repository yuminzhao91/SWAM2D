...
dfig1 = np.fromfile('validation_fsurf0/snapp00801', dtype=np.float32)
dfig1 = dfig1.reshape(481, 481).swapaxes(1,0)

dfig2 = np.fromfile('validation_fsurf1/snapp00801', dtype=np.float32)
dfig2 = dfig2.reshape(481, 481).swapaxes(1,0)

dfig3 = np.fromfile('validation_fsurf0/snapp01201', dtype=np.float32)
dfig3 = dfig3.reshape(481, 481).swapaxes(1,0)

dfig4 = np.fromfile('validation_fsurf1/snapp01201', dtype=np.float32)
dfig4 = dfig4.reshape(481, 481).swapaxes(1,0)

dfig5 = np.fromfile('validation_fsurf0/snapp01601', dtype=np.float32)
dfig5 = dfig5.reshape(481, 481).swapaxes(1,0)

dfig6 = np.fromfile('validation_fsurf1/snapp01601', dtype=np.float32)
