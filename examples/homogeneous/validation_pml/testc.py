...
tmp2 = np.fromfile('/home/pageotd/Work/FWM2DPSV/EXAMPLES/TEST_HOMOG/test_fsurf1/fsismos_z', dtype=np.float32)
tmp2 = tmp2.reshape(4, 2000).swapaxes(1,0)
...
tmp2x = np.fromfile('/home/pageotd/Work/FWM2DPSV/EXAMPLES/TEST_HOMOG/test_fsurf1/fsismos_x', dtype=np.float32)
tmp2x = tmp2x.reshape(4, 2000).swapaxes(1,0)
