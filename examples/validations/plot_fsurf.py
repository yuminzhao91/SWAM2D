...
dfig1 = np.fromfile('validation_fsurf/snapp00801', dtype=np.float32)
dfig1 = dfig1.reshape(481, 481).swapaxes(1,0)

dfig2 = np.fromfile('validation_fsurf/snapp01201', dtype=np.float32)
dfig2 = dfig2.reshape(481, 481).swapaxes(1,0)

dfig3 = np.fromfile('validation_fsurf/snapp01601', dtype=np.float32)
dfig3 = dfig3.reshape(481, 481).swapaxes(1,0)

dfig4 = np.fromfile('validation_fsurf/snapp02001', dtype=np.float32)
...
tmp1 = np.loadtxt('validation_fsurf/Uz_file_an')
tmp2 = np.fromfile('validation_fsurf/recz.bin', dtype=np.float32)
...
tmp1x = np.loadtxt('validation_fsurf/Ux_file_an')
tmp2x = np.fromfile('validation_fsurf/recx.bin', dtype=np.float32)
