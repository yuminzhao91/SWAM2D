...
dfig1 = np.fromfile('validation_dispersion/snapp00801', dtype=np.float32)
dfig1 = dfig1.reshape(121, 121).swapaxes(1,0)

dfig2 = np.fromfile('validation_dispersion/snapp01201', dtype=np.float32)
dfig2 = dfig2.reshape(121, 121).swapaxes(1,0)

dfig3 = np.fromfile('validation_dispersion/snapp01601', dtype=np.float32)
dfig3 = dfig3.reshape(121, 121).swapaxes(1,0)

dfig4 = np.fromfile('validation_dispersion/snapp02001', dtype=np.float32)
dfig4 = dfig4.reshape(121, 121).swapaxes(1,0)
...
font1.savefig('validation_snap_dispersion.ps', transparent=True)
sp.call('ps2eps -l -B -s b0 -c -n -f validation_snap_dispersion.ps', shell=True)
sp.call('rm -f validation_snap_dispersion.ps', shell=True)

# >> TRACES

tmp1 = np.loadtxt('validation_dispersion/Uz_file_an')
tmp2 = np.fromfile('validation_dispersion/recz.bin', dtype=np.float32)
...
tmp1x = np.loadtxt('validation_dispersion/Ux_file_an')
tmp2x = np.fromfile('validation_dispersion/recx.bin', dtype=np.float32)
...
font1.savefig('validation_trac_dispersion.ps', transparent=True)
sp.call('ps2eps -l -B -s b0 -c -n -f validation_trac_dispersion.ps', shell=True)
sp.call('rm -f validation_trac_dispersion.ps', shell=True)
